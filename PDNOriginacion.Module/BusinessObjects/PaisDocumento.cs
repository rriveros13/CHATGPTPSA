...
namespace PDNOriginacion.Module.BusinessObjects
{
    ...
    public class Pais : BaseObject
    {
        ...
        [ToolTip("Código del país del documento")]
        ...
        [ToolTip("Descripción del país del documento")]
        ...
        public XPCollection<Departamento> Departamentos=> GetCollection<Departamento>(nameof(Departamentos));
