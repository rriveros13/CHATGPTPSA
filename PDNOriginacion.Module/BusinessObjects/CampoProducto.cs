...
namespace PDNOriginacion.Module.BusinessObjects
{
    ...
    public class CampoProducto : BaseObject
    {
        ...
        public CampoProducto(Session session) : base(session) => ObjectType = typeof(Solicitud);
        ...
        [Indexed(nameof(Producto), Unique = true)]
        //[RuleRequiredField(DefaultContexts.Save)]
        [DataSourceProperty("Producto.CamposNoUsados")]
        public Campo Campo
        {
            get => campo;
        ...
        public XPCollection<CampoProductoExcep> ConfiguracionEspecial => GetCollection<CampoProductoExcep>(nameof(ConfiguracionEspecial));
