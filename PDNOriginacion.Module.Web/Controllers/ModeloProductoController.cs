...
namespace PDNOriginacion.Module.Web.Controllers
{
    ...
    public partial class ModeloProductoController : ViewController
    {
        ...
        private void ModeloProductoController_Activated(object sender, EventArgs e)
        {
            if (!View.Model.Id.Contains("ListView"))
            {
                ...
                if (UsarCustomDV != null && UsarCustomDV == "S")
                {
                    ...
                    IModelView myViewNode = modelViews["ModeloProducto_DetailView_" + codigoInstancia];
                    if(myViewNode != null)
