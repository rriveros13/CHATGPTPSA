...
namespace PDNOriginacion.Module.Web.Controllers
{
    ...
    public partial class PlanesController : ViewController
    {
        ...
        private void PlanesController_Activated(object sender, EventArgs e)
        {
            if (!View.Model.Id.Contains("ListView"))
            {
                ...
                if (UsarCustomDV != null && UsarCustomDV == "S")
                {
                    ...
                    IModelView myViewNode = modelViews["Planes_DetailView_" + codigoInstancia];
                    if (myViewNode != null)
