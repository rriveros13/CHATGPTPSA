...
namespace PDNOriginacion.Module.Web.Controllers
{
    ...
    public partial class PersonaEmpleoController : ViewController
    {
        public PersonaEmpleoController()
        {
            InitializeComponent();
        ...
        private void PersonaEmpleoController_Activated(object sender, EventArgs e)
        {
            if (!View.Model.Id.Contains("ListView"))
            {
                ...
                if (UsarCustomDV != null && UsarCustomDV == "S")
                {
                    ...
                    IModelView myViewNode = modelViews["PersonaEmpleo_DetailView_" + codigoInstancia];
                    if (myViewNode != null)
