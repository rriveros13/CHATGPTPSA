...
namespace PDNOriginacion.Module.Web.Controllers
{
    ...
    public partial class SolicitudPersonaRefComController : ViewController
    {
        public SolicitudPersonaRefComController()
        {
            InitializeComponent();
        ...
        private void SolicitudPersonaRefComController_Activated(object sender, EventArgs e)
        {
            if (!View.Model.Id.Contains("ListView"))
            {
                ...
                if (UsarCustomDV != null && UsarCustomDV == "S")
                {
                    ...
                    IModelView myViewNode = modelViews["SolicitudPersonaRefCom_DetailView_" + codigoInstancia];
                    if (myViewNode != null)
