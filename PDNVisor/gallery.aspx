<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="true" CodeBehind="gallery.aspx.cs" Inherits="PDNVisor.Gallery" %>
        ...
        <div id="gallery">
            <div id="gallery_icon_container">
                <div id="gallery_icon">
                 ...
                 <span id="gallery_header_title" runat="server">Document Gallery</span>
            </div>
