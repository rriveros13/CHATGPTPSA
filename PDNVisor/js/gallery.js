...
function resetButtons() {
    for (var i = 0; i < document.getElementById("gallery_container").children.length; i++) {
        if (document.getElementById("gallery_container").children[i].className != "separador") document.getElementById("gallery_container").children[i].className = "thumbnail_container";
    }
}